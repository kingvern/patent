...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FileBrowser",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \param allowEditing Whether to allow editing.
///
/// \param showCancelButton Whether to show the cancel button.
///
- (nonnull instancetype)initWithInitialPath:(NSURL * _Nullable)initialPath allowEditing:(BOOL)allowEditing showCancelButton:(BOOL)showCancelButton;
